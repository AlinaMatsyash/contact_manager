...
class _NameFormState extends State<NameForm> {
  ...
  TextEditingController _firstPhoneticController = TextEditingController();
  TextEditingController _lastPhoneticController = TextEditingController();
  TextEditingController _middlePhoneticController = TextEditingController();
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                keyboardType: TextInputType.text,
                textCapitalization: TextCapitalization.words,
                decoration: const InputDecoration(hintText: 'Suffix'),
              ),
              TextFormField(
              ...
              TextFormField(
                ...
                textCapitalization: TextCapitalization.words,
                decoration:
                    const InputDecoration(hintText: 'Phonetic first name'),
              ),
              TextFormField(
                ...
                textCapitalization: TextCapitalization.words,
                decoration:
                    const InputDecoration(hintText: 'Phonetic last name'),
              ),
              TextFormField(
                ...
                textCapitalization: TextCapitalization.words,
                decoration:
                    const InputDecoration(hintText: 'Phonetic middle name'),
              ),
            ],
          ),
        ),
